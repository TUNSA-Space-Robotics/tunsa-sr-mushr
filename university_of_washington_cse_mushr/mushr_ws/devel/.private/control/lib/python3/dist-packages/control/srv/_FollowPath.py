...
"""autogenerated by genpy from control/FollowPathRequest.msg. Do not edit."""
import codecs
import sys
...
class FollowPathRequest(genpy.Message):
  _md5sum = "30066e2d5ce03112d4a07ef84d906618"
  _type = "control/FollowPathRequest"
...
"""
  ...
  _slot_types = ['nav_msgs/Path','float64']
...
def _get_struct_d():
    ...
    return _struct_d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from control/FollowPathResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class FollowPathResponse(genpy.Message):
  _md5sum = "a3332c8c10694b43b1e4d49a22f0f93f"
  _type = "control/FollowPathResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2B().pack(_x.finished, _x.error))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.finished, _x.error,) = _get_struct_2B().unpack(str[start:end])
...
class FollowPath(object):
  _type          = 'control/FollowPath'
  _md5sum = 'c2bb767f9ceb2e20df0ce88c9cacf34d'
